...
class M3u8ServerManager(
    ...
    private val dns: okhttp3.Dns? = null,
) {
     ...
     */
    fun processM3u8Url(m3u8Url: String, referer: String? = null, userAgent: String? = null, cookies: String? = null): String? = server?.createLocalUrl(m3u8Url, referer, userAgent, cookies)
